		...
		<div class="container">
			...
			<div class="rCol">
				<ul class="aboutProject">
					<li class="about1">Добавить дефект и&nbsp;отправить заявление в&nbsp;местный орган власти<em></em></li>
					<li class="about2">Ждать 37&nbsp;календарных дней с&nbsp;момента регистрации вашего заявления</li>
					<li class="about3">Если дефект не&nbsp;устранили, отправлять жалобу в&nbsp;прокуратуру</li>
				</ul>
			</div>
		</div>
	</div>
