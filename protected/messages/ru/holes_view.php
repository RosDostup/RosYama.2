...
$MESS['HOLE_STATE_gibddre']    = 'Получен ответ из ГИБДД';
...
$MESS['HOLE_REQUEST_FORM_TO_COMMENT']          = 'Укажите наименование структурного подразделения ГИБДД и фамилию начальника';
...
$MESS['HOLE_CART_ADMIN_TEXT_6']  = 'Отметить факт отправки заявления в '.(Yii::app()->params->gibddOn ? 'ГИБДД' : 'местный орган власти');
...
$MESS['HOLE_PROSECUTOR_FORM_APPLICATION_DATA']         = 'Дата ответа из ГИБДД (dd.mm.YYYY)';
...
$MESS['REQUEST_TO_PROSECUTOR_SENT']          = 'отправлена жалоба на ГИБДД в прокуратуру';
